...
$this->append('css', $this->Html->css(['jmits']));

/**
 * Prepend `script` block with jQuery and Bootstrap scripts
 */
$this->prepend('script', $this->Html->script(['jquery/jquery.min', 'bootstrap/bootstrap']));
...
<?= $this->fetch('html') ?>
    ...
    <head>
        ...
        <?php echo $this->Html->meta('author', "James McDonald") ; ?>
